...
[![ci](https://codefloe.com/celema/log/badges/workflows/ci.yml/badge.svg?style=flat&logo=forgejo&logoColor=white&label=ci)](https://codefloe.com/celema/log/actions)
...
**Development has moved to <https://codefloe.com/celema/log>.**
